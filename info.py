...
API_ID = int(environ.get('API_ID', '20389441'))
API_HASH = environ.get('API_HASH', 'a1a06a18eb9153e9dbd447cfd5da24157')
...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/drago_mafia/3")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1234567').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-100112384461').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Drago_mafia')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Drago_mafia')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Drago_mafia')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001623631000'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Drago_mafia')
